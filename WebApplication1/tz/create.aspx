<%@ Page Title="tz.create" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="create.aspx.cs" Inherits="WebApplication1.tz.create" %>


<asp:Content ID="tz_create_content" ContentPlaceHolderID="ClientContent" runat="server">
    <div>
        <h2><%: Title %>.</h2>
        <h3>Create tz page.</h3>
    </div>
    <p class="text-danger">
